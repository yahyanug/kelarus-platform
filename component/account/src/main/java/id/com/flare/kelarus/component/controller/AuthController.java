...
public class AuthController {
    ...
    public AuthController(AuthenticationService authentication, EmailVerificationService verification, PasswordService passwords) {
    ...
    public GenericMessageResponse logout(@AuthenticationPrincipal Jwt principal, @Valid @RequestBody LogoutRequest request) {
