...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationServiceImpl(UserRepository users, UserCredentialRepository credentials,
            RefreshTokenRepository refreshTokens, EmailVerificationService verification,
    ...
    private AuthTokenResponse issueTokens(User user) {
        ...
        refreshTokens.save(new RefreshToken(user.getId(), tokens.hash(raw), now.plus(properties.refreshTokenTtl()), now));
