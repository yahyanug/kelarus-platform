...
public class EmailVerificationServiceImpl implements EmailVerificationService {
    ...
    public void create(User user) {
        ...
        events.publishEvent(new TokenDeliveryRequested(TokenDeliveryRequested.Purpose.EMAIL_VERIFICATION,
    ...
    public void verify(VerifyEmailRequest request) {
        ...
        EmailVerification token = verifications.findByTokenHash(hash).orElseThrow(INVALID_VERIFICATION_TOKEN::exception);
