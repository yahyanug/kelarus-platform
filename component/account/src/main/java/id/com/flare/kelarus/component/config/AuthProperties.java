...
public record AuthProperties(String jwtSecret, @DefaultValue("15m") Duration accessTokenTtl,
		@DefaultValue("30d") Duration refreshTokenTtl, @DefaultValue("24h") Duration emailVerificationTtl,
		@DefaultValue("30m") Duration passwordResetTtl) {

	public AuthProperties {
		for (Duration ttl : new Duration[] { accessTokenTtl, refreshTokenTtl, emailVerificationTtl,
				passwordResetTtl }) {
