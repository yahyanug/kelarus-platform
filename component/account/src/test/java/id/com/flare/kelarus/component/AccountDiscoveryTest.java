...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        "spring.datasource.url=jdbc:h2:mem:account-discovery;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
...
class AccountDiscoveryTest {
    ...
    public static class RegistryCleanup extends AbstractTestExecutionListener {
        ...
        @Override public void afterTestClass(TestContext context) {
            // afterTestClass listeners run in reverse order: close the fixture after Spring.
            REGISTRY.stop(0);
        }
    }
